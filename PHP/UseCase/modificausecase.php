...
END;
			...
			$pref=mysqli_real_escape_string($conn,$pref);
			$postf=mysqli_real_escape_string($conn,$postf);
			$princf=mysqli_real_escape_string($conn,$princf);
			$inclusionif=mysqli_real_escape_string($conn,$inclusionif);
			$estensionif=mysqli_real_escape_string($conn,$estensionif);
			$altef=mysqli_real_escape_string($conn,$altef);
