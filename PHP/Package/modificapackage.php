...
END;
					...
					if(($nomef!=$old_nomef) || ($descf!=$old_descf) || ($padref!=$old_padref) || ($diagf!=$old_diagf)){
						...
						$query1=$query1."'P')";
						$query1=mysqli_query($query1,$conn) or fail("Query fallita: Modifica Package Fallita - ".mysqli_error($conn));
					}
					if($modifica_pkg==true){
						...
						$query2=mysqli_query($query2,$conn) or fail("Query fallita: Modifica Package Correlati Fallita - ".mysqli_error($conn));
					}
