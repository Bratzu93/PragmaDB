...
END;
		...
		$padri=mysqli_query($conn,$query) or fail("Query fallita: ".mysqli_error($conn));
...
END;
		...
		$figli=mysqli_query($conn,$query) or fail("Query fallita: ".mysqli_error($conn));
...
END;
		...
		$relcl1=mysqli_query($query1,$conn) or fail("Query fallita: ".mysqli_error($conn));
		$relcl2=mysqli_query($query2,$conn) or fail("Query fallita: ".mysqli_error($conn));
