...
END;
					...
					if(($nomef!=$old_nomef) || ($descf!=$old_descf) || ($utilf!=$old_utilf) ||($padref!=$old_padref) || ($diagf!=$old_diagf)){
						...
						$query1=mysqli_query($query1,$conn) or fail("Query fallita: Modifica Classe Fallita - ".mysqli_error($conn));
					}
					if($modifica_clu==true){
						...
						$query2=mysqli_query($query2,$conn) or fail("Query fallita: Modifica EreditaDa Fallita - ".mysqli_error($conn));
					}
					if($modifica_cld==true){
						...
						$query3=mysqli_query($query3,$conn) or fail("Query fallita: Modifica Ereditano da lei Fallita - ".mysqli_error($conn));
					}
					if($modifica_clt==true){
						...
						$query4=mysqli_query($query4,$conn) or fail("Query fallita: Modifica Relazioni IN Fallita - ".mysqli_error($conn));
					}
					if($modifica_clq==true){
						...
						$query5=mysqli_query($query5,$conn) or fail("Query fallita: Modifica Relazioni OUT Fallita - ".mysqli_error($conn));
					}
					if($modifica_requi==true){
						...
						$query6=mysqli_query($query6,$conn) or fail("Query fallita: Modifica Requisiti Correlati Fallita - ".mysqli_error($conn));
					}
