...
if(empty($_SESSION['user'])){
	...
	$queries[]="SELECT DISTINCT r1.CodAuto,r1.IdRequisito,r1.Descrizione,r1.Tipo,r1.Importanza,r1.Padre,r1.Stato,r1.Soddisfatto,r1.Implementato,r1.Fonte,r2.IdRequisito,f.Nome
				...
				WHERE r1.Soddisfatto='0' AND (r1.Importanza='Obbligatorio' OR r1.Stato='1')
				ORDER BY h.Position";
	$queries[]="SELECT DISTINCT r1.CodAuto,r1.IdRequisito,r1.Descrizione,r1.Tipo,r1.Importanza,r1.Padre,r1.Stato,r1.Soddisfatto,r1.Implementato,r1.Fonte,r2.IdRequisito,f.Nome
				FROM RequisitiPackage rp JOIN (((_MapRequisiti h JOIN Requisiti r1 ON h.CodAuto=r1.CodAuto) LEFT JOIN Requisiti r2 ON r1.Padre=r2.CodAuto) JOIN Fonti f ON r1.Fonte=f.CodAuto) ON rp.CodReq=r1.CodAuto
...
echo<<<END
			...
			<div id="content">
				<h2>Componenti Integrate - Soddisfacimento Requisiti Correlati</h2>
